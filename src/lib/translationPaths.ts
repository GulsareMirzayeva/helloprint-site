...
export const copyPrintContentPaths = {
  ...
  color: 'commonWords.color',
  blackWhite: 'commonWords.blackWhite',
  colorOrBlackWhite: 'copyPrintPage.colorOrBlackWhite',
  colorOrBlackWhiteStandard: 'commonWords.colorOrBlackWhite',
  colorWithAsterisk: 'copyPrintPage.color',
  blackWhiteWithAsterisk: 'copyPrintPage.blackWhite',
  budget: 'commonWords.budget',
  highQuality: 'commonWords.highQuality',
  printerBudget: 'copyPrintPage.printerBudget',
  printerHq: 'copyPrintPage.printerHq',
