...
export default function ShopInfo() {
  ...
  return (
    <section className="flex justify-center w-full mt-8 bg-gradient-radial from-[#fd3964] via-[#FA2150] to-[#FB0036]">
      <div className="flex flex-col justify-center items-center min-w-[600px] h-96 p-0 m-0">
      ...
      <div className="flex flex-col justify-center min-w-[600px] h-96 p-0 m-0">
        <div className="flex flex-col items-center text-white ">
