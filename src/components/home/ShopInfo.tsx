...
export default function ShopInfo() {
  ...
  return (
    <section className="flex items-center justify-center w-full mt-8 bg-[#FB0036]">
      <div className="flex flex-col justify-center items-end w-full max-w-[800px] h-96 pr-96">
      ...
      <div className="flex flex-col justify-center max-w-[800px] h-96 bg-[#FB0036]">
        <div className="flex flex-col items-center text-white ">
